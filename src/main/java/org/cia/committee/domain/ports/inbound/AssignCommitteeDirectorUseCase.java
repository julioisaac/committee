...
public interface AssignCommitteeDirectorUseCase {
    void assignDirector(User user, UUID committeeUUID) throws UnauthorizedAccessException, ResourceNotFoundException;
}
